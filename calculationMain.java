...
//CALCULATION CODE TAKEN FROM CHEMAXON API;
//AVAILABLE - https://apidocs.chemaxon.com/jchem/doc/dev/java/api/

public class Main {

    private static String FILE_PATH = "C:\\Users\\Simon\\Downloads\\molecules1.sdf";
...
//AVAILABLE - https://apidocs.chemaxon.com/jchem/doc/dev/java/api/
        ...
        public static TreeMap<Integer, Integer> lipinskyCalculator() throws IOException, PluginException {
            ...
            //System.out.println(lipinksiMap);
...
//AVAILABLE - https://apidocs.chemaxon.com/jchem/doc/dev/java/api/
        ...
        // read input molecule
         ...
         /*       // print result
                ...
                System.out.println(rotatableBond);*/
